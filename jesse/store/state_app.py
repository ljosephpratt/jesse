...
class AppState:
    ...
    def set_exchange_api_key(self, exchange_api_key_id: str) -> None:
        ...
        self.exchange_api_key = ExchangeApiKeys.get_or_none(
    ...
    def set_notifications_api_key(self, notifications_api_key_id: str) -> None:
        ...
        self.notifications_api_key = NotificationApiKeys.get_or_none(
            NotificationApiKeys.id == notifications_api_key_id
        )
