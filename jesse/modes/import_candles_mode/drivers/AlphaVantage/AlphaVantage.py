...
class AlphaVantage(CandleExchange):
    ...
    def fetch(self, symbol: str, start_timestamp: int, timeframe: str = '1D') -> Union[list, None]:
        """
        ...
        if timeframe not in timeframe_map:
            raise ValueError(f"Timeframe {timeframe} not supported by Alpha Vantage driver")
