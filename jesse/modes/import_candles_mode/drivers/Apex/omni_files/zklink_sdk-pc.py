...
_UniffiLib.uniffi_zklink_sdk_fn_func_closest_packable_fee_amount.restype = (
    _UniffiRustBuffer
)
...
_UniffiLib.uniffi_zklink_sdk_fn_func_closest_packable_token_amount.restype = (
    _UniffiRustBuffer
)
...
_UniffiLib.uniffi_zklink_sdk_checksum_func_closest_packable_fee_amount.restype = (
    ctypes.c_uint16
)
_UniffiLib.uniffi_zklink_sdk_checksum_func_closest_packable_token_amount.argtypes = ()
_UniffiLib.uniffi_zklink_sdk_checksum_func_closest_packable_token_amount.restype = (
    ctypes.c_uint16
)
...
_UniffiLib.uniffi_zklink_sdk_checksum_func_is_fee_amount_packable.restype = (
    ctypes.c_uint16
)
_UniffiLib.uniffi_zklink_sdk_checksum_func_is_token_amount_packable.argtypes = ()
_UniffiLib.uniffi_zklink_sdk_checksum_func_is_token_amount_packable.restype = (
    ctypes.c_uint16
)
...
class Order:
    ...
    def get_eth_sign_msg(
        self, quote_token: str, based_token: str, decimals: "int"
    ) -> str:
...
def closest_packable_fee_amount(fee: "BigUint") -> "BigUint":
    ...
    return _UniffiConverterTypeBigUint.lift(
        _rust_call(
            _UniffiLib.uniffi_zklink_sdk_fn_func_closest_packable_fee_amount,
...
def closest_packable_token_amount(amount: "BigUint") -> "BigUint":
    ...
    return _UniffiConverterTypeBigUint.lift(
        _rust_call(
            _UniffiLib.uniffi_zklink_sdk_fn_func_closest_packable_token_amount,
            _UniffiConverterTypeBigUint.lower(amount),
        )
    )
...
def is_fee_amount_packable(fee: "BigUint") -> bool:
    ...
    return _UniffiConverterBool.lift(
        _rust_call(
            _UniffiLib.uniffi_zklink_sdk_fn_func_is_fee_amount_packable,
            _UniffiConverterTypeBigUint.lower(fee),
        )
    )
...
def is_token_amount_packable(amount: "BigUint") -> bool:
    ...
    return _UniffiConverterBool.lift(
        _rust_call(
            _UniffiLib.uniffi_zklink_sdk_fn_func_is_token_amount_packable,
            _UniffiConverterTypeBigUint.lower(amount),
        )
    )
