...
class Alpaca(CandleExchange):
    ...
    def fetch(self, symbol: str, start_timestamp: int, timeframe: str = '1m') -> Union[list, None]:
        ...
        try:
            ...
            for bar in data['bars']:
                timestamp = int(datetime.fromisoformat(bar['t'].replace('Z', '')).timestamp() * 1000)
                result.append({
    ...
    def get_available_symbols(self) -> list:
        ...
        try:
            ...
            popular_symbols = [
                "AAPL-USD", "MSFT-USD", "AMZN-USD", "TSLA-USD", "GOOGL-USD", 
                "META-USD", "NVDA-USD", "JPM-USD", "V-USD", "MA-USD",
                "JNJ-USD", "WMT-USD", "PG-USD", "UNH-USD", "HD-USD",
                "SPY-USD", "QQQ-USD", "IWM-USD", "DIA-USD", "VTI-USD"
            ]
            ...
            return [
                "AAPL-USD", "MSFT-USD", "AMZN-USD", "TSLA-USD", "GOOGL-USD", 
                "META-USD", "NVDA-USD", "SPY-USD", "QQQ-USD"
            ]
