...
def fast_mama(source, fastlimit, slowlimit):
    ...
    for i in range(1, n):
        ...
        dt[i] = (
            ...
            - 0.0962 * (sp[i - 6] if i - 6 >= 0 else 0)
        ) * (0.075 * (p_arr[i - 1] if i - 1 >= 0 else 0) + 0.54)

        q1[i] = (
            0.0962 * dt[i]
            + 0.5769 * (dt[i - 2] if i - 2 >= 0 else 0)
            - 0.5769 * (dt[i - 4] if i - 4 >= 0 else 0)
            - 0.0962 * (dt[i - 6] if i - 6 >= 0 else 0)
        ) * (0.075 * (p_arr[i - 1] if i - 1 >= 0 else 0) + 0.54)
        ...
        jI[i] = (
            ...
            - 0.0962 * (i1_arr[i - 6] if i - 6 >= 0 else 0)
        ) * (0.075 * (p_arr[i - 1] if i - 1 >= 0 else 0) + 0.54)
        ...
        re_temp = i2_arr[i] * (i2_arr[i - 1] if i - 1 >= 0 else 0) + q2_arr[i] * (
            q2_arr[i - 1] if i - 1 >= 0 else 0
        )
        im_temp = i2_arr[i] * (q2_arr[i - 1] if i - 1 >= 0 else 0) - q2_arr[i] * (
            i2_arr[i - 1] if i - 1 >= 0 else 0
        )
        ...
        mama_arr[i] = alpha_arr[i] * source[i] + (1 - alpha_arr[i]) * (
            mama_arr[i - 1] if i - 1 >= 0 else source[i]
        )
        fama_arr[i] = 0.5 * alpha_arr[i] * mama_arr[i] + (1 - 0.5 * alpha_arr[i]) * (
            fama_arr[i - 1] if i - 1 >= 0 else source[i]
        )
