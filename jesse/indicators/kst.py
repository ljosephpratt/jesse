...
def kst(
    ...
    aroc1 = _sma(
        _roc(source, roc_period1, sequential=True), sma_period1, sequential=True
    )
    aroc2 = _sma(
        _roc(source, roc_period2, sequential=True), sma_period2, sequential=True
    )
    aroc3 = _sma(
        _roc(source, roc_period3, sequential=True), sma_period3, sequential=True
    )
    aroc4 = _sma(
        _roc(source, roc_period4, sequential=True), sma_period4, sequential=True
    )
